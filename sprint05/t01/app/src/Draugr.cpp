...
static std::string BuildString(double health, int frostResist) {
    return std::string(
        std::string("Draugr (") + std::to_string(static_cast<int>(health))
...
void Draugr::shoutPhrase(int shoutNumber) const {
    std::string roar = BuildString(m_health, m_frostResist);
